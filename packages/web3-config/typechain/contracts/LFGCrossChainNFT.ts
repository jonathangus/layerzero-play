...
export interface LFGCrossChainNFTInterface extends utils.Interface {
  functions: {
    ...
    "crossChain(uint16,uint256)": FunctionFragment;
    "currentTokenId()": FunctionFragment;
    "estimateFees(uint16,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "counter()"
      | "crossChain"
      | "crossChain(uint16,uint256)"
      | "currentTokenId"
      | "currentTokenId()"
      | "estimateFees"
      | "estimateFees(uint16,uint256)"
      | "failedMessages"
  ...
  encodeFunctionData(
    functionFragment: "crossChain(uint16,uint256)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "estimateFees(uint16,uint256)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ReceivedNFT(uint16,address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ReceivedNFT"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ReceivedNFT(uint16,address,uint256,uint256)"
  ): EventFragment;
...
export interface ReceivedNFTEventObject {
  _srcChainId: number;
  _from: string;
  _tokenId: BigNumber;
  counter: BigNumber;
}
export type ReceivedNFTEvent = TypedEvent<
  [number, string, BigNumber, BigNumber],
  ReceivedNFTEventObject
>;

export type ReceivedNFTEventFilter = TypedEventFilter<ReceivedNFTEvent>;
...
export interface LFGCrossChainNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LFGCrossChainNFTInterface;
  ...
  filters: {
    ...
    "ReceivedNFT(uint16,address,uint256,uint256)"(
      _srcChainId?: null,
      _from?: null,
      _tokenId?: null,
      counter?: null
    ): ReceivedNFTEventFilter;
    ReceivedNFT(
      _srcChainId?: null,
      _from?: null,
      _tokenId?: null,
